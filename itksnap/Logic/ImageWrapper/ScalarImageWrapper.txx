...
::CheckImageIntensityRange() 
{
  ...
  // egmod
  // todo:  fix this
  /* Not efficient and not strictly necessary.  Added to avoid intensity
     window problems when switching to and from the ACPC alignment tool 
     when the cursor location corresponds to a blank slice */
   m_MinMaxCalc->SetRegion( ImageWrapper<TPixel>::m_Image->GetLargestPossibleRegion() );
