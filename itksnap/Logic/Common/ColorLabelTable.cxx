...
const char *ColorLabelTable::m_ColorList[ColorLabelTable::m_ColorListSize] =
 {
  "#00FF00", "#FF0000", "#FFC00A", "#FDFF00", "#6C27CC", "#FF2370", // first 15 replaced
  "#FF00FF", "#FF6800", "#B8FF30", "#990099", "#CC3399", "#FF96EF", //
  "#FF859D", "#008B8B", "#6CFFD6", "#6A5ACD", "#DDA0DD", "#E9967A", //
...
::ColorLabelTable()
{
  ...
  const unsigned int INIT_VALID_LABELS = 15;
