...
public:
  ...
  virtual void OnSliceInputAction(int id) = 0;
  ...
  // IRIS: Line mode
  virtual void OnLineAttributesUpdate() = 0;
  ...
  // IRIS: Landmark actions
  virtual void SetLandmarkMode( LandmarkType landmark, ToolbarModeType tool, int paintbrushSize = 1 ) = 0;

  // IRIS: SABRE actions
  virtual void UpdateSabreGridDisplay() = 0;
  virtual void OnBtnSaveSabreGrid() = 0;
  virtual void OnBtnSaveSabreTrace() = 0;
  virtual void OnBtnLoadSabreGrid() = 0;
  virtual void OnBtnLoadSabreTrace() = 0;
  virtual void OnBtnResetSabre() = 0;  

  // IRIS: SABRE 3D actions
  virtual void OnBtnSabre3DRight() = 0;
  virtual void OnBtnSabre3DLeft() = 0;
  virtual void OnBtnSabre3DTop() = 0;
  virtual void OnBtnSabre3DBottom() = 0;
  virtual void OnBtnSabre3DFront() = 0;
  virtual void OnBtnSabre3DBack() = 0;
  virtual void OnSabre3DTransferFunctionAction( unsigned int button ) = 0;
  virtual void OnSabre3DInteractionModeToggle() = 0;
  virtual void Set3DLandmarkMode( LandmarkType landmark ) = 0;
  virtual void OnBtnSabre3DAccept() = 0;
  virtual void OnBtnSabre3DUndo() = 0;
  virtual void OnBtnSabre3DRedo() = 0;
  virtual void OnBtnSabre3DDeleteLandmark() = 0;
  virtual void OnBtnSabre3DDeleteLandmarks() = 0;
  virtual void OnBtnSabre3DResetModule() = 0;
  virtual void OnBtnSabre3DFixCamera() = 0;
  virtual void OnBtnSabre3DTransformFunctionGuess() = 0;
  virtual void OnBtnSabre3DResetCamera() = 0;
  virtual void OnBtnSabre3DToggleTrace() = 0;
  virtual void OnSliderSabre3D() = 0;
  virtual void OnBtnSabre3DDisconnect() = 0;

  // IRIS: Flood fill actions
  virtual void OnFloodFillClearCurrentSliceLimits( unsigned int window ) = 0;
  virtual void OnBtnFloodFillLoadLimits() = 0;
  virtual void OnBtnFloodFillSaveLimits() = 0;
  virtual void OnFloodFillClearLimitsAction() = 0;
  virtual void OnFloodFillRedoLimit( unsigned int window ) = 0;
  virtual void OnFloodFillUndoLimit( unsigned int window ) = 0;
  virtual void OnBtnFloodFill3D() = 0;

  // IRIS: Alignment actions
  virtual void OnBtnAlignmentChange( int degreesX, int degreesY, int degreesZ, int shiftX, int shiftY, int shiftZ ) = 0;
  virtual void OnBtnAlignmentInverseTransform() = 0;
  virtual void OnBtnAlignmentIdentityTransform() = 0;
  virtual void OnBtnAlignmentResample() = 0;
  virtual void OnBtnAlignmentSaveTransform() = 0;
  virtual void OnAlignmentSaveTransformAction() = 0;
  virtual void OnBtnAlignmentLoadTransform() = 0;
  virtual void OnAlignmentLoadTransformAction() = 0;
  virtual void OnAlignmentInterpolateAction() = 0;
  ...
  virtual void OnFloodFillUpdate() = 0;
