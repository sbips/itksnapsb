...
class LandmarkPaintbrushInteractionMode;
class LandmarkPolygonInteractionMode;
class AnnotationInteractionMode;
class FloodFillInteractionMode;
class AlignmentInteractionMode;
...
public:
  ...
  void EnterLandmarkPaintbrushMode();

  void EnterAlignmentMode();

  void EnterFloodFillMode();
  ...
  void SetFloodFill3D( bool value );
  ...
  AlignmentInteractionMode* GetAlignmentInteractionMode() { return m_AlignmentMode; };
  FloodFillInteractionMode* GetFloodFillInteractionMode() { return m_FloodFillMode; };
...
protected:
  ...
  LandmarkPaintbrushInteractionMode* m_LandmarkPaintbrushMode;

  AlignmentInteractionMode* m_AlignmentMode;

  FloodFillInteractionMode* m_FloodFillMode;
