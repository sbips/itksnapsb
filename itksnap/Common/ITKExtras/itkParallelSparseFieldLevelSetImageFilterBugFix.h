...
Module:    $RCSfile: itkParallelSparseFieldLevelSetImageFilterBugFix.h,v $
Language:  C++
...
=========================================================================*/
#ifndef __itkParallelSparseFieldLevelSetImageFilterBugFix_h_
...
class ITK_EXPORT ParallelSparseFieldLevelSetImageFilterBugFix :
...
public:
  ...
  itkTypeMacro(ParallelSparseFieldLevelSetImageFilterBugFix, FiniteDifferenceImageFilter);
...
protected:
  ...
  {
    ParallelSparseFieldLevelSetImageFilterBugFix* Filter;
...
private:
  ...
  ParallelSparseFieldLevelSetImageFilterBugFix(const Self&); // purposely not implemented
...
#include "itkParallelSparseFieldLevelSetImageFilterBugFix.txx"
#endif
